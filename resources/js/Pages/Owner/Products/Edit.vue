...
const updateProduct = (id) => {
    router.put(route('owner.products.update', {product: id}), form)
}

const deleteProduct = (id) => {
    router.delete(route('owner.products.destroy', { product: id }), {
      ...
      <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
          <div class="p-6 text-gray-900">
            ...
            <form v-on:submit.prevent="updateProduct(form.id)">
              <div class="container px-5 mx-auto">
                <div class="-m-2">
                  ...
                  <div class="p-2 w-1/2 mx-auto">
                    <div class="relative">
                      <label class="leading-7 text-sm text-gray-600">現在の在庫</label>
                      <div class="w-full bg-gray-100 bg-opacity-50 rounded text-base outline-none text-gray-700 py-1 px-3 leading-8">{{ form.current_quantity }}</div>
                    </div>
                  </div>
                  <div class="p-2 w-1/2 mx-auto">
                    <div class="relative flex justify-around">
                      <div>
                        <input type="radio" name="type" id="type_inc" v-model="form.type" v-bind:value="props.constants.add"><label for="type_inc" class="leading-7 text-sm text-gray-600">追加</label>
                      </div>
                      <div>
                        <input type="radio" name="type" id="type_dec" v-model="form.type" v-bind:value="props.constants.reduce"><label for="type_dec" class="leading-7 text-sm text-gray-600">削減</label>
                      </div>
                    </div>
                  </div>
                  <div class="p-2 w-1/2 mx-auto">
                  ...
                  <MicroModal name="image1" v-bind:images="images" v-bind:currentId="props.product.image1" v-bind:currentImage="(props.product.image_first || {}).filename" @update:imageValue="((e) => {form.image1 = Number(e)})" />
                  <MicroModal name="image2" v-bind:images="images" v-bind:currentId="props.product.image2" v-bind:currentImage="(props.product.image_second || {}).filename" @update:imageValue="((e) => {form.image2 = Number(e)})" />
                  <MicroModal name="image3" v-bind:images="images" v-bind:currentId="props.product.image3" v-bind:currentImage="(props.product.image_third || {}).filename" @update:imageValue="((e) => {form.image3 = Number(e)})" />
                  <MicroModal name="image4" v-bind:images="images" v-bind:currentId="props.product.image4" v-bind:currentImage="(props.product.image_fourth || {}).filename" @update:imageValue="((e) => {form.image4 = Number(e)})" />
                  <div class="p-2 w-1/2 mx-auto">
                    <div class="relative flex justify-around">
                      <div>
                  ...
                  <div class="p-2 w-full flex justify-around mt-4">
                    ...
                    <button type="button" v-on:click="deleteProduct(form.id)" class="text-white bg-red-400 border-0 mx-4 py-2 px-4 focus:outline-none hover:bg-red-500 rounded">削除</button>
                  </div>
                </div>
              </div>
            </form>
